"""Build the Samudra Manthan comic with browser-native Devanagari shaping."""
...
OUTPUT = REPO / "output" / "pdf" / "samudra_manthan_001_comic.pdf"
...
.cover::after {{
  ...
  background: linear-gradient(180deg, rgba(25,12,4,.25), rgba(25,12,4,.05) 55%, rgba(25,12,4,.55));
}}
.cover-box {{
